...
local C = {
    bg0         = Color3.fromRGB(8, 8, 8),        -- Main frame background (near black)
    bg1         = Color3.fromRGB(15, 15, 15),     -- Header and cards background
    bg2         = Color3.fromRGB(25, 25, 25),     -- Playable lists / list elements
    bg3         = Color3.fromRGB(35, 35, 35),     -- Speed inputs / sliders background
    border      = Color3.fromRGB(80, 65, 25),    -- Inner frame outlines (dark gold)
    glassBorder = Color3.fromRGB(218, 165, 32),   -- Outer glow/border (gold)
    text        = Color3.fromRGB(255, 255, 255),  -- White body text
    text2       = Color3.fromRGB(220, 210, 180),  -- Soft gold-white text
    text3       = Color3.fromRGB(140, 130, 100),  -- Dim gold text
    accent      = Color3.fromRGB(255, 215, 0),    -- Main accent (bright gold)
    bg4         = Color3.fromRGB(20, 20, 20),     -- Toggle backgrounds
    red         = Color3.fromRGB(255, 70, 70),    -- Close dot
    yellow      = Color3.fromRGB(255, 190, 40),   -- Minimize dot
    green       = Color3.fromRGB(40, 220, 120),   -- Success / Active
...
Notify = function(msg, dur, extra)
    ...
    TweenService:Create(n, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out),
        {Position = UDim2.new(1,-360,0,20)}):Play()
...
TitleBar.Size = UDim2.new(1,0,0,44); TitleBar.ZIndex = 31; TitleBar.Active = false
do
    ...
    t.Text = "Reanimation"; t.TextColor3 = C.accent
...
local function stopRecording()
    ...
    task.spawn(function()
        ...
        -- Save to file
        local filename = "ReanimData/RecordedAnim_" .. tostring(math.floor(tick())) .. ".lua"
        pcall(function()
...
local function updateStressState()
    if stressEnabled then
        TweenService:Create(stressToggleBg, TweenInfo.new(0.2), {BackgroundColor3 = C.green}):Play()
...
RunService.RenderStepped:Connect(function()
    ...
    fpsLbl.Text = "FPS: " .. fps
    if fps >= 55 then fpsLbl.TextColor3 = C.green
...
RunService.RenderStepped:Connect(LPH_NO_VIRTUALIZE(function()
    ...
    -- FPS optimization: skip every other frame for non-critical checks
    _frameSkipCounter = (_frameSkipCounter or 0) + 1
    if _frameSkipCounter % 2 == 0 then return end
